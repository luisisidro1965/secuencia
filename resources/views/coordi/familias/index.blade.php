    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                <a href="{{ route('familias.create') }}" class="btn btn-success">Crear Familia</a>
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        @foreach ($familias as $familia)
                            <tr>
                                <td style="width: 10px">{{ $familia->id }}</td>
                                <td>{{ $familia->clave }}</td>
                                <td>{{ $familia->nombre }}</td>
                                <td style="width: 20px">
                                    <a href="{{ route('familias.edit', $familia->id) }}" class="btn btn-primary">
                                        Edit
                                    </a>
                                </td>
                                <td style="width: 20px">
